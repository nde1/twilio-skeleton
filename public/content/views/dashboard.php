...
<div class="list-group">
	<a href="/calls" class="list-group-item">
	...
	<a  class="list-group-item modalButton" data-toggle="modal" data-src="/user/new?embed=1" data-title="Edit Profile" data-target="#modalbox">
		<h4 class="list-group-item-heading">Add New User</h4>
		<p class="list-group-item-text">
			Add a new user
		</p>
	</a>
	<a  class="list-group-item modalButton" data-toggle="modal" data-src="/user/edit/<?php echo $me->id?>?embed=1" data-title="Edit Profile" data-target="#modalbox">
